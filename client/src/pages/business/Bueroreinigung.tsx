        ...
        <div className="container">
          ...
          <Tabs defaultValue="leistungen" className="mb-20">
            <TabsList className="grid w-full grid-cols-3 mb-8">
              ...
              <TabsTrigger value="ablauf">Ablauf & Zeiten</TabsTrigger>
              <TabsTrigger value="pakete">Preis-Pakete</TabsTrigger>
            </TabsList>
            
            <TabsContent value="leistungen" className="space-y-6">
              <Card className="p-8">
                <h3 className="text-3xl font-bold mb-6">Umfassende Büroreinigung</h3>
            ...
            <TabsContent value="ablauf" className="space-y-6">
              <Card className="p-8">
                <h3 className="text-3xl font-bold mb-6">Flexibler Reinigungsablauf</h3>
              ...
              <Card className="p-8">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <Card className="p-6 bg-slate-50">
                    ...
                    <div className="text-3xl font-bold text-primary mb-2">ab CHF 35</div>
