      ...
      <section className="py-16 bg-white">
        <div className="container">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-slate-900 mb-4 text-center">
            Beschaffungsmanagement in Zürich, Zug und Luzern
          </h2>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-20">
            ...
            <Link href="/housekeeping">
              <Card className="p-6 hover:shadow-lg transition-shadow h-full">
                ...
                <p className="text-sm text-slate-600">
                  Premium Housekeeping-Services für Hotels und gehobene Wohnbereiche
                </p>
              </Card>
            </Link>
            <Link href="/business/bueroreinigung">
              <Card className="p-6 hover:shadow-lg transition-shadow h-full">
                ...
                <p className="text-sm text-slate-600">
                  Professionelle Büroreinigung für Unternehmen - flexibel und zuverlässig
                </p>
              </Card>
            </Link>
            <Link href="/basis/unterhaltsreinigung">
              <Card className="p-6 hover:shadow-lg transition-shadow h-full">
                ...
                <p className="text-sm text-slate-600">
                  Regelmäßige Reinigung für Büros und Gewerbe - zuverlässig und flexibel
                </p>
              </Card>
            </Link>
          </div>
