      ...
      <section className="py-16 bg-white">
        <div className="container">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-slate-900 mb-4 text-center">
            Industriereinigung in Zürich, Zug und Luzern
          </h2>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-20">
            <Link href="/business/hallenreinigung">
              <Card className="p-6 hover:shadow-lg transition-shadow h-full">
                ...
                <p className="text-sm text-slate-600">
                  Effiziente Reinigung großer Hallen und Lagerflächen mit Industriegeräten
                </p>
              </Card>
            </Link>
            <Link href="/business/maschinenreinigung">
              <Card className="p-6 hover:shadow-lg transition-shadow h-full">
                ...
                <p className="text-sm text-slate-600">
                  Fachgerechte Reinigung von Produktionsmaschinen und Industrieanlagen
                </p>
              </Card>
            </Link>
