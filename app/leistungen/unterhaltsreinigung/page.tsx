...
export default function Unterhaltsreinigung() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900 mb-6">
                Unterhaltsreinigung für Liegenschaften und Gewerbe
              </h1>
      ...
      {/* Nachfüllservice als Teil der Unterhaltsreinigung (R3a, K08) */}
      <section className="py-16 bg-slate-50">
        <div className="container max-w-5xl">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-slate-900 mb-4">Nachfüllservice</h2>
          <p className="text-slate-600 mb-8 max-w-3xl">Verbrauchsmaterial füllen wir im Rahmen der Unterhaltsreinigung nach. Welche Artikel dazugehören, legen wir mit Ihnen fest.</p>
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              "Toilettenpapier, Handtücher und Seife",
              "Müllsäcke und Reinigungstücher",
