...
import { HallenreinigungPage, MaschinenreinigungPage } from './pages/services/StandardServices.jsx'
import { UnterhaltsreinigungPage, FensterreinigungPage } from './pages/services/EssentiellServices.jsx'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <Link to="/faq" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-[#0A2540] hover:bg-gray-50 rounded-lg transition-colors">FAQ</Link>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden py-4 border-t border-gray-100">
            <div className="space-y-2">
              ...
              <Link to="/referenzen" className="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg">Referenzen</Link>
              <Link to="/karriere" className="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg">Karriere</Link>
              <Link to="/faq" className="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg">FAQ</Link>
              <Link to="/kontakt" className="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg">Kontakt</Link>
            </div>
          </div>
        )}
      </div>
