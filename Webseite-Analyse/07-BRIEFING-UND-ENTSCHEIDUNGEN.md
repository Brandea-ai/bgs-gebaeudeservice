...
| E10 | 24.09.2026 | **Ausstehend (Nutzerentscheidung angefragt):** Weiteres Vorgehen beim Push. Jeder Push auf den Arbeits-Branch hat automatisch ein geschütztes Vercel-Preview-Deployment ausgelöst (6 Stück, N035). Das widerspricht Regel 3 („kein Deployment“), die E03 nur für Commit und Push aufhebt. **Bis zur Entscheidung wird nur lokal committet, nicht gepusht.** Optionen: (1) gebündelt weiter pushen und Previews in Kauf nehmen, (2) Nutzer richtet in Vercel einen „Ignored Build Step“ ein, (3) nur lokal committen. | Vercel unterdrückt Git-Deployments nur per `vercel.json` oder Projekteinstellung, beides ist für den Agenten gesperrt (Regel 3, E08). Produktion war nie betroffen | — | Nutzer (ausstehend) | Antwort des Nutzers |
