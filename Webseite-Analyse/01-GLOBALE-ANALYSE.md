...
- [x] Untersuchen, ob die fünf Leistungen inhaltlich unterscheidbar sind und sinnvolle Auswahlhilfe bieten. → *BEFUND (Phase 4): Unterscheidbar nur nach Name, nicht nach Inhalt. 13 Konflikte K01–K13, fehlende Auswahlhilfe (P02). Zielbild mit fünf Kernleistungen und bedingten Zusatzseiten in 03, Abschnitt 2a*
...
| „einem der führenden Reinigungsunternehmen in der Schweiz“, „führende Reinigungsfirma in Zug“ | Über uns, Zug | fehlt | Streichen | Redaktion |
...
| Winterdienst-Zusagen: „ab 2cm Schneehöhe“, „zwischen 4-7 Uhr morgens“, „digital mit Fotos, GPS-Daten und Zeitstempel dokumentiert“, „einen monatlichen Bericht als Nachweis für die Erfüllung Ihrer Räumpflicht“, „Eigene Streufahrzeuge“, „Dokumentation für Versicherung“ (Nachtrag Phase 3) | Winterdienst, Aussenanlagen | fehlt | Nur mit bestätigter Einsatzregel und einem Beispielbericht (SEITE-P06-001, -P07-001) | Geschäftsführung Kunde |
...
| Leistungs- und Vertragszusagen: „ab 3 Monaten Laufzeit mit 1 Monat Kündigungsfrist“, „Wir garantieren Vertretung“, „von 500 m² bis zu mehreren 10.000 m²“, Zeitangaben wie „Eine Wohnung (100m²) dauert ca. 1-2 Tage“, „Ein durchschnittliches Bürogebäude (50 Fenster) dauert 2-3 Stunden“ (Nachtrag Phase 3) | Büroreinigung, Hallen, Baureinigung, Fenster | fehlt | Vertragsbedingungen nur nach Freigabe (AGB), Zeitangaben nur als Beispiel mit Annahmen | Geschäftsführung Kunde |
...
- [x] Jede kommerzielle Kernseite hat einen klaren Themen-/Intent-Schwerpunkt. → *BEFUND im Bestand (K01–K13), Zuständigkeitsmatrix für das Zielbild in 03, Abschnitt 2a*
...
- [x] Geschäftliche Zielbegriffe, Region, Sprache, Gerät und Brand-/Non-Brand-Trennung vor Rankingauswertung festlegen. → *Arbeitshypothese festgelegt (03, Abschnitte 1 und 2a): Region Kantone Luzern und Zug, Deutsch, Marke „BGS Gebäudeservice“ getrennt von Leistung + Ort. Eine Rankingauswertung gibt es nicht (keine Suchdaten, N038 nur Stichprobe). Zielbegriffe mit dem Kunden bestätigen (R10)*
...
- [ ] Google-Unternehmensprofil, passende Kategorien, tatsächliche Einzugsgebiete und konsistente Firmenangaben prüfen, sofern das Unternehmen dafür geeignet ist. [S32] → *NICHT GEPRÜFT: Rückfrage an den Kunden (B11)* *Nachtrag Phase 4: Profil NICHT PRÜFBAR (R11). Verzeichniseinträge bei local.ch, search.ch, ofri.ch, Moneyhouse, Facebook und einem Bewertungsportal gefunden (N038). Vorgabe für einheitliche Firmenangaben in 03, Abschnitt 5*
...
- **Ist-Zustand:** Das Impressum bestätigt KI-generierte Bilder, die „repräsentieren die Qualität unserer Dienstleistungen“. Sichtbar werden solche Bilder als eigenes Team, als Vorher/Nachher-Beleg und als Referenzprojekt eingesetzt. Die „Team“-Kleidung wechselt je Bild (rot bzw. dunkelblau mit grünem Logo).
